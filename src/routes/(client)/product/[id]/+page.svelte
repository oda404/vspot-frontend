...
<div class="space-y-4">
    ...
    <section class="space-y-4">
        ...
        <div class="flex flex-col lg:flex-row lg:space-x-12">
            <div class="space-y-4">
                <img
                    class="w-full h-full lg:min-w-[550px] lg:min-h-[550px] lg:w-[550px] lg:h-[550px] aspect-square"
            ...
            <div class="space-y-1 w-full mt-4 lg:mt-0">
                ...
                <div class="flex items-center space-x-2 !mt-4">
                    ...
                    <button
                        ...
                        class="text-lg whitespace-nowrap px-8 w-full p-2 bg-vspot-green text-vspot-primary-bg disabled:bg-vspot-secondary-bg disabled:text-vspot-text-hovered"
                        on:click={() => {
                            cart_add_item(
                                data.product.internal_id,
                                data.product.pretty_internal_id,

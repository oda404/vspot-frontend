...
var translations = {
    "ro": {
        ...
        "page.send_confirm_email.description": "V-am trimis un email de confirmare pe ",
        ...
        "page.send_confirm_email.wrong_email": "Adresa de email gresita? Schimba adresa",

        "page.confirm_email.title.success": "Va multumim!",
        "page.confirm_email.description.success": "Adresa dumneavoastra de email a fost confirmata. Va uram cumparaturi placute pe V-Spot!",
        ...
        "order.noaccount_notice": "Inainte sa trimiti comanda te rugam sa-ti faci un cont, e gratis!",
        "order.send": "Trimite",
        ...
        "description.orderplacedextrainfo": "Pentru mai multe detalii vezi rubrica \"Comenzile mele\" a profilului tau. Pentru oricare alte probleme ne poti contacta direct pe noi",
    ...
    "en": {
        ...
        "order.noaccount_notice": "Before continuing with the order please create an account",
        "order.send": "Send",
